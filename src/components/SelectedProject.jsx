...
export default function SelectedProject({projectData,onDeleteProject,onAddTask,onDeleteTask,tasks}) {
    ...
    return <div className="w-[35rem] mt-16">
        ...
        <Tasks onAddNewTask={onAddTask} onDeleteTask={onDeleteTask} tasks={tasks}></Tasks>
    </div>
}